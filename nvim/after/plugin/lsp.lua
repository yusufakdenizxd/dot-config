local telescopeSetup,telescopeBuiltin = pcall(require ,'telescope.builtin')
if not telescopeSetup then
  return
end

local neodevSetup,neodev = pcall(require,'neodev')
if not neodevSetup then
  return
end

local masonLspConfigSetup,mason_lspconfig =pcall(require ,'mason-lspconfig')
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>rk', vim.lsp.buf.hover, 'Hover Documentation')
